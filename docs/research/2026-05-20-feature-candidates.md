...
| **B7** | Multi-provider image abstraction | M | Enables English-language output (D2) — ✅ Phases 1-2 done v1.6.17 / v1.6.20 (`ImageProvider` protocol + 3 built-in providers including `openai-gpt-image-1`); Phases 3-4 queued |
