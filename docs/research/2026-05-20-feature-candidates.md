...
| **B3** | Real screenshot end-to-end snapshot tests | M–L | CI dep on Playwright (already required) | 📋 spec drafted — `docs/superpowers/specs/2026-05-20-screenshot-e2e-snapshot-tests.md` (4 phases) |
